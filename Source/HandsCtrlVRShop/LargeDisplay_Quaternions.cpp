...
#include "LargeDisplay_Quaternions.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat ULargeDisplay_Quaternions::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void ULargeDisplay_Quaternions::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
	if (SceneComponent)
	{
...
void ULargeDisplay_Quaternions::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
	if (SceneComponent)
	{
...
void ULargeDisplay_Quaternions::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
	if (SceneComponent)
	{
...
void ULargeDisplay_Quaternions::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
	if (Actor)
	{
...
void ULargeDisplay_Quaternions::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
	if (Actor)
	{
...
void ULargeDisplay_Quaternions::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
	if (Actor)
	{
